...
QT_MOC_LITERAL(3, 17, 32), // "std::pair<std::vector<Cube>,int>"
QT_MOC_LITERAL(4, 50, 4) // "load"

    },
    "Loader\0sendData\0\0std::pair<std::vector<Cube>,int>\0"
    "load"
};
...
void Loader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< std::pair<std::vector<Cube>,int>(*)>(_a[1]))); break;
        ...
        {
            typedef void (Loader::*_t)(std::pair<std::vector<Cube>,int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Loader::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Loader::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Loader.data,
...
// SIGNAL 0
void Loader::sendData(std::pair<std::vector<Cube>,int> _t1)
{
